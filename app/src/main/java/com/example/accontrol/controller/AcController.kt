...
class AcController {
    ...
    fun setDriverTemp(temp: Int) { require(temp in 16..32); send("AC_DRIVER_TEMP", temp.toString()) }
    fun setPassengerTemp(temp: Int) { require(temp in 16..32); send("AC_PASSENGER_TEMP", temp.toString()) }
